...
void print_help() {
    ...
    printf("specifies the distance between coordinate center points and their bounds\n");
    ...
    printf("specifies the maximum amount of iterations to generate the mandelbrot set\n");
    printf("Example: ./cmandel -m 1024\n\n");

    printf("-p: hue power specifier\n");
    printf("specifies how rainbow you want the mandelbrot set\n");
    printf("this is evaluated as an exponent so be careful with it (or don't I guess)\n");
    ...
    printf("true or false specifier setting whether the set should be colored black\n");
